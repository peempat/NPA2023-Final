...
accessToken = "Bearer M2E1MzEwODktOGY5OC00MWVmLWFkOWQtZDQ3ZDI4YjlkYjg1ZjljMWZjNDYtNDNm_P0A1_bc884c7a-820b-497b-8b60-00b4d15ea95d"
...
roomIdToGetMessages = (
    "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLXdlc3QtMl9yL1JPT00vNTAyYTJhZDAtNTc0Ny0xMWVmLWJhMDctODUyMDlkZGZiNmZj"
)
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    #  e.g.  "/66070123 create"
    if message.find("/65070721") == 0:

        # extract the command
        command = message[len("/65070721 ") :].strip()
        print(command)
